"use strict";
{
    ...
    class Square {
        ...
        draw() {
            ...
            const test = body === null || body === void 0 ? void 0 : body.getBoundingClientRect();
            const bodyRect = body === null || body === void 0 ? void 0 : body.getBoundingClientRect();
            const maxWidth = bodyRect === null || bodyRect === void 0 ? void 0 : bodyRect.width;
            const maxHeight = bodyRect === null || bodyRect === void 0 ? void 0 : bodyRect.height;
            ...
            if (typeof maxWidth === 'number') {
                ...
                div.style.left = `${Math.floor(Math.random() * (maxWidth - 0 + 1)) + 0}px`;
            }
            if (typeof maxHeight === 'number') {
                console.log(Math.floor(Math.random() * (maxHeight - 0 + 1)) + 0);
                div.style.top = `${Math.floor(Math.random() * (maxHeight - 0 + 1)) + 0}px`;
            }
